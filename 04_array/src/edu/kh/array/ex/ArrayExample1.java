...
public class ArrayExample1 {
	...
	/*
	 * 배열(Array) - 같은 자료형의 변수를 하나의 묶음으로 다루는 것. - 묶여진 변수들은 하나의 배열명으로 불려지고 구분은 index를
	...
	public void ex2() {
		...
		// arr[0~3] 전부 JVM 에 의해 0으로 초기화 되어있는 상태
		...
		// 해석 배열의 인덱스 범위를 벗어남 : 길이를 4칸짜리 배열인데 없는 인덱스 번호인 4에 접근했다
	...
	public void ex8() {
		...
		// 1-2) 입력한 문자열을 한글자씩 잘라내어 char 배열에
		// 모든 요소에 순서대로 대입하기
		for (int i = 0; i < arr.length; i++) {
