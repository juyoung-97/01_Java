...
public class ServerService {
	// TCP Socket 프로그래밍
	// - TCP 는 신뢰성 있는 연결을 보장하며
	// 소켓은 이연결의 끝점 역할을 하며, 데이터 송수신 통로가 됨
...
//		6. 보조 스트림을 통해 성능 개선
			...
			// 바이트 기반 InputStream 을 연결 할 수 있도록
...
//		7. 스트림을 통해 읽고 쓰기
			...
			// PrintWriter.println(문자열) : 주어진 데이터를 문자형태로 출력하고, 출력후 줄바꿈 추가
			pw.println(str); // 서버 -> 클라이언트로 데이터를 출력(전송)
			pw.flush(); // flush() : 스트림 내용을 밀어냄 (출력시 꼭작성)
