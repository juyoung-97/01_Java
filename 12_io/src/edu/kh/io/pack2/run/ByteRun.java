...
/*
		...
		System.out.println(System.identityHashCode(str2)); // 1392838282 다르다
		str1 = str1 + "world";
		System.out.println(System.identityHashCode(str1)); // 1706377736 불변성의 법칙
		// 2. 리터럴 표기법
		String str3 ="Hello";
		String str4 ="Hello";
		
		System.out.println(System.identityHashCode(str3)); // 523429237
		System.out.println(System.identityHashCode(str4)); // 523429237 같다
		str3 = str3 + "world";
		System.out.println(System.identityHashCode(str3)); // 1804094807 불변성
		// String 상수 풀
		...
		sb.append("12345");
		System.out.println(sb); // Hello world!12345
		System.out.println(System.identityHashCode(sb)); // 951007336 */
