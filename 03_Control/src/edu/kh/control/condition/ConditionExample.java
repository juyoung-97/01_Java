...
public class ConditionExample { // 기능 제공용 클래스
	...
	Scanner sc = new Scanner(System.in); // 필드 변수
	...
	public void ex4() {
		...
		// 9,10,11 가을
		// 1~12사이가 아닐땐 "해당하는 계절이 없습니다" 출력
		
		String season = null; // 계절명을 저장할 변수
