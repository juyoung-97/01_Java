...
public class MemberService {
	...
	public int emptyIndex() {
		...
		// for 문을 수행했지만 인덱스 값이 return 되지 않은 경우
		// 해당 위치 코드가 수행된다
