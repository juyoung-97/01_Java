...
public class PolyService {
	...
	public void printCar(Car temp) {
		...
		// 부모타입 참조변수 = 자식타입객체
		// -> 다형성의 업캐스팅 모양과 똑같다
		// -> Car 와 Spark / Tesla 는 상속관계이기 때문에
		// temp 라는 Car(부모타입) 매개변수에 Car / Tesla / Spark 의
		// 주소가 참조가능하다 ! ! !
	...
	public void ex2() {
		...
		System.out.println(arr[1] instanceof Tesla); // true (본인 맞음)
		System.out.println(arr[1] instanceof Spark); // false (본인 아님)
	...
	public void ex4() {
		...
		Car c1 = new Tesla();
		// Tesla 객체를 만들어 Car 타입 참조변수 c1 에 담음
		// -> 업캐스팅 상태

		// Spark s1 = (Spark)c1; // c1을 관계없는 Spark 로 다운캐스팅 하려고함
		...
		// 예외처리
		if (c1 instanceof Spark) { // c1 이 Spark 이거나 상속관계인가?
			Spark s1 = (Spark) c1;
	...
	public void ex5() {
		...
		// 반환형 출처
		// Car 객체에 있는 toString() 메서드를 호출하겠다
		// 프로그램 "실행 전"
