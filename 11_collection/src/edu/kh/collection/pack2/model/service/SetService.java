...
public class SetService {
	...
	public void method1() {
		...
		set.add(null); // TreeSet 은 null 저장 지원 안함(자동정렬을 위해 내부적으로 compareTo() 라는 메서드 이용 시)
		set.add(null); // NullPointerException 이 발생하기 때문)
		set.add(null);
		...
		// 5. void clear() : Set 에 있는 내용을 모두 삭제
		set.clear();
		System.out.println(set);
	...
	public void method2() {
		...
		System.out.println("향상된 for문 이용법");
	...
	public void method3() {
		...
		// HashCode(), equals() 오버라이딩 필수적으로 진행되어야 함. (중요)
		// *******************************************************
	 ...
	 * int -> Integer 라는 Wrapper 클래스 이용하여 저장
	 * TreeSet<Integer>
	 * -> Integer 는 Comparable 인터페이스 이미 상속되어있음
	 * -> 바로 사용 가능 ! (자동 정렬됨)
	 * 
	 */
	public void method4() {
