...
public class MapService {
	...
	public void ex1() {
		...
		// key 중복 테스트
		map.put(1, "전주영"); // 중복 허용 X , 대신 Value 덮어쓰기
	...
	public void ex2() {
		...
		// : 매개변수로 전달받은 Key 와 대응되는 Value 반환
		...
		// Map 에서 Key 만 보면 Set 특징을 가진다( 중복 저장 X )
		// -> 이를 활용하여 Map 에서 keySet() 메서드 제공
		// -> Key 만 모아서 Set 으로 반환
	...
	public void ex3() {
		// List 에 Map 을 여러개 추가하여 다루기
		
		// List 객체 생성
		List<Map<String, Object>> list = new ArrayList<>();
		// List 객체 생성되었고, 해당 list 에는 Map 만 들어올 수 있음을 제한함
		// -> Map 객체는 아직 생성 X
