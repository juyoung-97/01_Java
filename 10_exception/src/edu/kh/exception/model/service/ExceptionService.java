...
public class ExceptionService {
	...
	public void ex2() {
		...
		try {
			...
			System.out.println("왜 예외가 발생했지 모르겠군");
			e.printStackTrace();
		}
	...
	public void ex3() {
		...
		try {
			...
			sc.close(); // 스캐너 통로닫기 : 메모리 누수 방지
			
		}
		
		// try-with-resources : finally 에서 일일히 close() 호출하지 않아도
		// 자동으로 리소스를 닫아주는 방식
	...
	public void ex5() throws UserException {
		...
		// 개발자가 원하는 모양새의 예외 클래스를 만들어 쓸 수 있다
		// -> 사용자 정의 예외 클래스
		// UserException 사용하여 강제 예외 발생시키기
		throw new UserException("내가 만든 예외 처리 해줘 !!!!!");
